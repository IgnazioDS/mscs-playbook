...
- `pip install -r modules/09-object-oriented-analysis-and-design/03-implementations/python/requirements.txt`
- `python -m pytest -q modules/09-object-oriented-analysis-and-design/03-implementations/python/tests`
