...
- `pip install -r modules/10-natural-language-processing/03-implementations/python/requirements.txt`
- `python -m pytest -q modules/10-natural-language-processing/03-implementations/python/tests`
- `python modules/10-natural-language-processing/03-implementations/python/src/nlp/mini_project/cli.py ticket-triage --seed 42`
- `python modules/10-natural-language-processing/03-implementations/python/src/nlp/mini_project/cli.py kb-search --k 3`
- `python modules/10-natural-language-processing/03-implementations/python/src/nlp/mini_project/cli.py evaluate --seed 42 --k 3`
...
- `python modules/10-natural-language-processing/03-implementations/python/src/nlp/mini_project/cli.py ticket-triage --seed 42 --out out/triage.md`
