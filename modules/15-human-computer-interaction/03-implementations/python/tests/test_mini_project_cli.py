...
def test_study_report_cli_matches_golden(tmp_path: Path) -> None:
    ...
    cli_path = repo_root / "modules/15-human-computer-interaction/03-implementations/python/src/hci/mini_project/cli.py"
    ...
    expected = (
        repo_root
        / "modules/15-human-computer-interaction/03-implementations/python/tests/fixtures/expected_report.md"
    ).read_text()
